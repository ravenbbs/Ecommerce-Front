        ...
        <div className="flex justify-between  items-baseline ">
          ...
          <div className="flex gap-8 max-sm:gap-2 items-baseline w-full max-w-lg flex-wrap justify-end">
            {category.properties.slice(0, 2).map((prop) => (
              <div
                key={prop.name}
                className="bg-blue-200 px-1 py-1 mb-2 rounded-md font-semibold"
              >
                {prop.name}
                <select
                  onChange={(ev) =>
                ...
                >
                  ...
                  {prop.values.map((val) => (
                    <option key={val} className="font-semibold" value={val}>
                      {val}
                    </option>
                  ))}
                </select>
            ...
            <div className="bg-blue-200 px-1 py-1 mb-2 rounded-md font-semibold">
              ...
              >
                ...
                <option value="_id-desc">Producto, nuevo</option>
                <option value="_id-asc">Producto, antiguo</option>
              </select>
            </div>
          </div>
        </div>
